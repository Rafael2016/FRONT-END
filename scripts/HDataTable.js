class HDataTable {
	...
	constructor(idElementoDestino, { dataset, ordemColuna, removerBotao, btnAcao, linhaPadrao, nomeArquivo, colunasExportar } = {}) {
		...
		$.when(
			$.getScript("https://cdn.jsdelivr.net/gh/Rafael2016/front-end/scripts/datatables/1.10/js/jquery.dataTables.min.js"),
			$.getScript("https://cdn.jsdelivr.net/gh/Rafael2016/front-end/scripts/datatables/1.10/js/dataTables.min.js"),
			$.getScript("https://cdn.jsdelivr.net/gh/Rafael2016/front-end/scripts/datatables/1.10/js/dataTables.buttons.min.js"),
	...
	getButton() {
		...
		var btnExcel = {
			extend: 'excel',
			text: '<img src="../../../../../../SIGO_INTEGRADO_3/imagens/Excel_2010.png" title="Gerar Excel" style="width:15px; height:15px;"></img>',
			filename: this.nomeArquivo,
			exportOptions: exportOptions
		};
		var btnPdf = {
			extend: 'pdf',
			text: '<img src="../../../../../../SIGO_INTEGRADO_3/imagens/icon_pdf.png" title="Gerar PDF" style="width:15px; height:15px;"></img>', orientation: 'landscape',
			filename: this.nomeArquivo,
			exportOptions: exportOptions
		};
		var btnCopy = {
			extend: 'copy',
			text: '<img src="../../../../../../SIGO_INTEGRADO_3/imagens/copy.png" title="Copiar tabela" style="width:15px; height:15px;"></img>',
			exportOptions: exportOptions
		};
		var buttons = [];
